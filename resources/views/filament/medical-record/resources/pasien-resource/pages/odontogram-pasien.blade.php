            ...
            <g transform="scale(2)" id="gmain">
                @foreach ($teeth as $tooth)
                    <g id="P{{ $tooth['number'] }}" transform="{{ $tooth['transform'] }}" style="padding-top: 100px">
                        ...
                        {{-- {{ dd($tooth['kondisi']['Atas'] || $tooth['kondisi']['Bawah'] || $tooth['kondisi']['Kanan'] || $tooth['kondisi']['Kiri'] || $tooth['kondisi']['Tengah']  === 'non') }} --}}
                        @if ($tooth['kondisi']['Atas'] || $tooth['kondisi']['Bawah'] || $tooth['kondisi']['Kanan'] || $tooth['kondisi']['Kiri'] || $tooth['kondisi']['Tengah']  === 'non')
                            <text x="3" y="-2" stroke="navy" fill="black" stroke-width="0.1"
                                style="font-size: 6pt;font-weight:normal" class="text-xs">
                                {{ $tooth['kondisi']['Atas'] ?? $tooth['kondisi']['Bawah'] ?? $tooth['kondisi']['Kanan'] ?? $tooth['kondisi']['Kiri'] ?? $tooth['kondisi']['Tengah'] }}
                            </text>
                        @else
                        ...
                        @else
                            <polygon wire:click="odontogram('{{ $tooth['number'] }}', 'Atas', '{{ $tooth['transform'] }}')"
                        ...
                        @if ($tooth['posisi']['Bawah'] !== null && $tooth['kondisi']['Bawah'] === 'car')
                            <polygon
                                ...
                                id="T" opacity="1" class="cursor-pointer hover:fill-blue-200"></polygon>
                        @else
                            <polygon wire:click="odontogram('{{ $tooth['number'] }}', 'Bawah', '{{ $tooth['transform'] }}')"
                        ...
                        @if ($tooth['posisi']['Kanan'] !== null && $tooth['kondisi']['Kanan'] === 'car')
                            <polygon
                                ...
                                id="T" opacity="1" class="cursor-pointer hover:fill-blue-200"></polygon>
                        @else
                            <polygon wire:click="odontogram('{{ $tooth['number'] }}', 'Kanan', '{{ $tooth['transform'] }}')"
                        ...
                        @if ($tooth['posisi']['Kiri'] !== null && $tooth['kondisi']['Kiri'] === 'car')
                            <polygon
                                ...
                                id="T" opacity="1" class="cursor-pointer hover:fill-blue-200"></polygon>
                        @else
                            <polygon wire:click="odontogram('{{ $tooth['number'] }}', 'Kiri', '{{ $tooth['transform'] }}')"
                        ...
                        @if ($tooth['posisi']['Tengah'] !== null && $tooth['kondisi']['Tengah'] === 'car')
                            <polygon
                                ...
                                id="T" opacity="1" class="cursor-pointer hover:fill-blue-200"></polygon>
                        @else
                            <polygon wire:click="odontogram('{{ $tooth['number'] }}', 'Tengah', '{{ $tooth['transform'] }}')"
